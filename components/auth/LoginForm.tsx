  ...
  return (
    <form action={formAction} className="w-full space-y-3">
      ...
      <div className="group relative space-y-1.5">
        <label
          className="block text-[10px] uppercase tracking-[0.2em] text-body-text font-medium"
          htmlFor="email"
        >
          Email Address
        </label>
      ...
      <div className="group relative space-y-1.5">
        <div className="flex justify-between items-end">
          ...
          <Link
            className="text-[10px] uppercase tracking-[0.1em] text-sage-grove hover:text-deep-forest transition-colors duration-300"
            href="#"
          >
            Forgot?
          </Link>
